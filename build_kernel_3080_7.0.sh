...
# 这两步都影响 make 实际传给 gcc 的 flag
# 7.0+ 会自动启用 CONFIG_X86_NATIVE_CPU,效果 = -march=native (对 Zen2 = znver2)
optimize_cpu "znver2" "AMD Ryzen 5 3500X (Zen2) via X86_NATIVE_CPU"
...
# 编译(7.0+ 用 X86_NATIVE_CPU,KCFLAGS 可选)
...
echo ""
echo "增量编译提示:"
echo "  - ./build_kernel_3080_7.0.sh             增量编译"
echo "  - ./build_kernel_3080_7.0.sh --rebuild   强制完整重新编译"
echo "  - ./build_kernel_3080_7.0.sh --reconfig  重新配置内核选项"
echo "  - ./build_kernel_3080_7.0.sh --no-nvidia 跳过 NVIDIA DKMS"
