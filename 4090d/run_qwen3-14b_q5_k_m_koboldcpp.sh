...
#
# =============================================================
# Qwen3-14B-Q5 (KoboldCpp) API 启动脚本 (4090D 24GB)
# =============================================================
#
...
# ├─────────────┼──────────┼────────────┼────────────────────────┤
# │ 80K         │ 66.0     │ 30341      │ batch=512, threads=14  │
# └─────────────┴──────────┴────────────┴────────────────────────┘
# 测试环境: NVIDIA GeForce RTX 4090 D 24GB, CUDA compute 8.9
# 模型: Qwen3-14B-Q5_K_M.gguf
# =============================================================
#
# 【启动方式】
#   cd /opt/my-shell/4090d
#   nohup ./run_qwen3-14b_q5_k_m_koboldcpp.sh > /tmp/14b_q5_koboldcpp.log 2>&1 &
#   echo $!  # 记录PID
#
# 【查看日志】
#   tail -f /tmp/14b_q5_koboldcpp.log
#
# 【停止服务】
...
#     -d '{"model": "Qwen3-14B-Q5_K_M.gguf", "messages": [{"role": "user", "content": "你好"}], "max_tokens": 50}'
#
# 【性能测试】
#   cd /opt/my-shell
#   python3 test_api.py
...
#
# 【使用 opencode】
#   opencode -m openai/Qwen3-14B-Q5_K_M.gguf
#
# =============================================================
...
MODEL_DIR="/opt/gguf/Qwen3-14B-Q5_K_M.gguf"
KOBOLDCPP_DIR="/opt/koboldcpp"

echo "=============================="
echo "启动 Qwen3-14B-Q5_K_M (KoboldCpp) API 服务"
...
echo '  -d '"'"'{"model": "Qwen3-14B-Q5_K_M.gguf", "messages": [{"role": "user", "content": "你好"}], "max_tokens": 50}'"'"''
echo ""
echo "性能参数:"
echo "  模型: Qwen3-14B-Q5_K_M.gguf"
echo "  框架: KoboldCpp"
echo "  上下文: 80K"
echo "  最大输出: 32K"
echo "  GPU层数: 99"
