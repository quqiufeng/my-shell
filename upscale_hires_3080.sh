...
# =============================================================================
#
# 用法: ./upscale_hires.sh <input> [output] [strength] [steps]
#
...
if [ -z "$INPUT_FILE" ]; then
  ...
  echo "  ./upscale_hires.sh image.png out.png 0.4 12   # 重绘0.4, 12步"
  echo "  ./upscale_hires.sh image.png out.png 0.3 8    # 快速模式"
  exit 1
fi
