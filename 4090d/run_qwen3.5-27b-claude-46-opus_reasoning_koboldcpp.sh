...
#
# =============================================================
# Qwen3.5-27B-Claude-4.6-Opus-Reasoning (KoboldCpp) API 脚本 (4090D 24GB)
# =============================================================
#
# 【启动方式】
#   cd /opt/my-shell/4090d
#   nohup ./run_qwen3.5-27b-claude-46-opus_reasoning_koboldcpp.sh > /tmp/27b_koboldcpp.log 2>&1 &
#   echo $!  # 记录PID
#
# 【查看日志】
#   tail -f /tmp/27b_koboldcpp.log
#
# 【停止服务】
...
#     -d '{"model": "Qwen3.5-27B.Q4_K_M.gguf", "messages": [{"role": "user", "content": "你好"}], "max_tokens": 50}'
#
# 【性能测试】
#   cd /opt/my-shell
#   python3 test_api.py
...
#           "name": "Qwen3.5-27B-Claude-46-Opus-Reasoning (KoboldCpp)",
...
#
# 【使用 opencode】
#   opencode -m openai/Qwen3.5-27B.Q4_K_M.gguf
#
# =============================================================
...
echo "=============================="
echo "启动 Qwen3.5-27B-Claude-4.6-Opus-Reasoning (KoboldCpp) API 服务"
...
echo '  -d '"'"'{"model": "Qwen3.5-27B.Q4_K_M.gguf", "messages": [{"role": "user", "content": "你好"}], "max_tokens": 50}'"'"''
echo ""
echo "性能参数:"
