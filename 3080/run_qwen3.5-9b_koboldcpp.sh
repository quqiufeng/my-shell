...
# KV量化: q4_0 (--quantkv 1)
#
# 【实测性能】2026-04-16 RTX 3080 10GB (当前脚本参数: Q4_K_M, BATCH=1024, CTX=128K, smartcache=0)
#   快速排序: 54.9, 线程安全: 64.5, 二分查找: 50.8, 数据库索引: 61.5
#   Python性能优化: 51.8, 归并排序: 62.3, HTTP/HTTPS: 51.5, LRU缓存: 52.0
#   堆排序: 56.4, Dijkstra算法: 51.9, 一致性哈希: 63.0, 令牌桶: 63.9
#   阻塞队列: 64.7, 红黑树: 45.9, B+树: 57.2, A*算法: 57.8
#   KMP算法: 61.7, 布隆过滤器: 50.3, 跳表: 63.7, 并查集: 52.9
#   线段树: 57.9, 字典树: 36.6, 最小生成树: 35.0, 拓扑排序: 35.4
#   最长公共子序列: 39.7, 编辑距离: 36.5, 滑动窗口: 40.6, 双指针: 35.9
#   平均约: 55.0 tok/s (前20题, 后半段衰减至 35-40 tok/s, test_api.py 超时中断)
#
# 【历史对照数据】
#   [2026-04-16 Q5_K_S, BATCH=1024, CTX=128K, smartcache=0] 约 56.0 tok/s (30题完整跑完, 显存: 9788MiB)
#   [2026-04-16 Q5_K_S, BATCH=2048, CTX=128K] 约 20-26 tok/s (显存爆满 9699MiB，性能极差，测试中断)
#   [2026-04-16 Q5_K_S, BATCH=512, CTX=128K, 旧参数] 约 34.8 tok/s (前20题中断, smartcache 未关)
#   [2026-04-16 Q5_K_S, BATCH=512, CTX=128K, smartcache=0] 约 55.7 tok/s (30题完整跑完, 显存: 9310MiB)
#
