...
MODEL_DIR="/opt/gguf/Qwen_Qwen3.5-35B-A3B-Q4_K_M.gguf"
LLAMA_SERVER="/opt/llama.cpp/bin/llama-server"

echo "=============================="
echo "启动 Qwen3.5-35B-A3B API 服务"
...
echo '  -d '"'"'{"model": "Qwen_Qwen3.5-35B-A3B-Q4_K_M.gguf", "messages": [{"role": "user", "content": "你好"}], "max_tokens": 50}'"'"''
echo ""
echo "性能参数:"
echo "  模型: Qwen_Qwen3.5-35B-A3B-Q4_K_M.gguf"
echo "  上下文: 32K"
echo "  GPU层数: 99"
